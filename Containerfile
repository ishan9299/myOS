...
ARG BASE_IMAGE="${BASE_IMAGE:-ghcr.io/ublue-os/${BASE_IMAGE_NAME}-main@sha256:5839e29752226d57c80eeb7fe886017461e1cbbf68c1c63198efbdb9aeb79bfc}"
ARG KERNEL_REF="${KERNEL_REF:-ghcr.io/bazzite-org/kernel-bazzite@sha256:e9e588497aa51cdb95e51d79f2ef4e632eeba3b4dbbf2c510f58a556026ff116}"
...
ARG IMAGE_NAME="${IMAGE_NAME:-my_bazzite}"
ARG IMAGE_VENDOR="${IMAGE_VENDOR:-ublue-os}"
ARG IMAGE_BRANCH="${IMAGE_BRANCH:-stable}"
ARG BASE_IMAGE_NAME="${BASE_IMAGE_NAME:-lepidolite}"
