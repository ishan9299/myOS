...
dnf5 install -y meson wayland-devel wayland-protocols-devel mesa-libEGL-devel mesa-libGLES-devel vulkan-loader-devel vulkan-headers libdrm-devel mesa-libgbm-devel libinput-devel libxkbcommon-devel systemd-devel pixman-devel libseat-devel hwdata libdisplay-info-devel libliftoff-devel glslang lua
